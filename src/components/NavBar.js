  ...
  render() {
    ...
    return (
      <header>
        ...
        <a href="/signin" className="account"> <Account className="suffix" />
        <ul className="ul-popup">
          <li className="li-popup">
            <a href="/signin" className="popup-link">Log In</a>
          </li>
        </ul>
        </a>
      ...
      <ul className="ul-cart">
        <li>
          <svg className="suffix" viewBox="2 -5 35 41" style={{
            ...
            {this.props.quantity > 0 ? <g>
              ...
              <text x="21" y="11" textAnchor="middle" fontSize="10" fontWeight="bold" >{quantity}</text>
            </g> : ""}
            <defs>
        ...
        <li className="li-cart">
          <br/>
          <p className="col-cart">
            <span className="header-cart">Product</span>
            <span className="header-cart">Price</span>
            <span className="header-cart">Quantity</span>
          </p>
          <br/>
          <p className="col-cart">
            <span className="item-cart">iPhone 13</span>
            <span className="item-cart">27.000.000</span>
            <span className="item-cart">2</span>
          </p>
          <p className="col-cart">
            <span className="item-cart">iPhone 11</span>
            <span className="item-cart">16.000.000</span>
            <span className="item-cart">1</span>
          </p>
          <br/>
          <hr/>
          <br/>
          <p className="col-cart">
            <span className="header-cart">Total</span>
            <span className="header-cart">70.000.000</span>
